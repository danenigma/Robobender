       ...
       function setParms(obj,parms)
        ...
        function integrateCommands(obj)
            ...
            for i=1:obj.numSamples-1
                ...
                dth = obj.curvArray(i+1)*ds;
                %th = th + dth
                obj.poseArray(3,i+1) = obj.poseArray(3,i) + dth;
                %x = x + dx
                obj.poseArray(1,i+1) = obj.poseArray(1,i) + ds*cos(obj.poseArray(3,i+1));
                %y = y + dy
                obj.poseArray(2,i+1) = obj.poseArray(2,i) + ds*sin(obj.poseArray(3,i+1));
